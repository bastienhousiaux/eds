...
{
    wp_register_style('eds-style', get_template_directory_uri().'/style.css');
    wp_enqueue_style('eds-style');

  
    wp_register_style('eds-bootstrap', get_template_directory_uri().'/css/bootstrap/bootstrap.min.css');
    ...
    {
        wp_register_script('eds-accordion', get_template_directory_uri().'/js/accordion.js', array('jquery',"jquery-ui-core","jquery-ui-accordion","jquery-ui-button"), "1.2");

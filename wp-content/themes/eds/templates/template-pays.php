<?php
/**
 * Template Name: Paysage Institutionnel
 */
?>
<?php get_header()?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h2>VIII.Paysage institutionnel</h2>
                <div class="contenu-accordeon">
                    <div id="accordion">
                        <h3>8.1 Comment le président de la chambre est choisi ? </h3>
                        <div>
                            <p>
                                Le président est élu par l'assemblée plénière pour la durée d'une législature (5 ans).
                                Généralement, il fait partie de la majorité.Le président est élu par l'assemblée
                                plénière pour la durée d'une législature (5 ans). Généralement, il fait partie de la
                                majorité.
                            </p>
                        </div>

                        <h3>8.2 Pourquoi autant de division ? (fédéral, région, commune...)</h3>
                        <div>
                            <p>
                        ...
                        <h3>8.3 Qui paye tous ces ministres ? </h3>
                        <div>
                            <p>
                                Le contribuable via l'impôts des personnes physiques.
                            </p>
                        </div>

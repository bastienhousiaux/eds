<?php
/**
 * Template Name: Union Européenne
 */
?>
<?php get_header()?>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-sm-12">
                ...
                <h2>XII.L'union européennne</h2>
                <div class="contenu-accordeon">
                    <div id="accordion">
                        <h3>12.1 Où se situent les bâtiments principaux de l'union européenne? </h3>
                        <div>
                            <p>
                                La commission européenne et le parlement européen sont répartis sur 2 sites : à
                                Bruxelles et à Strasbourg (France).
                            </p>
                        </div>

                        <h3>12.2 Y a-t-il des partis?</h3>
                        <div>
                            <p>
                                Oui, chaque pays de l'Union Européenne a différents partis représentés à l'Europe
                            </p>
                        </div>

                        <h3>12.3 Pourquoi les pays hors de la communauté doivent venir en aide à l’europe? </h3>
                        <div>
                            <p>
                                C’est une question de profit, des pays comme l’inde et la chine sont soit émergent,
                                soit pays fort économiquement. S’ils rachètent la dette des pays européens, c’est comme
                                s’ils investissaient dans des pays, ce sont des formes de prêt d’argent entre pays,
                                donc avec des intérêts et des profits.
                            </p>
                        </div>
